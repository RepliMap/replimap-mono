...
class TestScannerRateLimitingIntegration:
    ...
    def test_ec2_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "EC2Scanner should use rate_limited_paginate"
    ...
    def test_vpc_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "VPCScanner should use rate_limited_paginate"
    ...
    def test_rds_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "RDSScanner should use rate_limited_paginate"
    ...
    def test_iam_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "IAMRoleScanner should use rate_limited_paginate"
    ...
    def test_compute_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "ComputeScanner should use rate_limited_paginate"
    ...
    def test_networking_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "NetworkingScanner should use rate_limited_paginate"
    ...
    def test_storage_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "EBSScanner should use rate_limited_paginate"
    ...
    def test_elasticache_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "ElastiCacheScanner should use rate_limited_paginate"
    ...
    def test_messaging_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in sqs_source, "SQSScanner should use rate_limited_paginate"
        assert 'rate_limited_paginate' in sns_source, "SNSScanner should use rate_limited_paginate"
    ...
    def test_monitoring_scanner_uses_rate_limiting(self):
        ...
        assert 'rate_limited_paginate' in source, "CloudWatchLogGroupScanner should use rate_limited_paginate"
    ...
    def test_all_scanners_have_rate_limiter_import(self):
        ...
        assert len(missing_imports) == 0, f"Scanners missing rate_limiter import: {missing_imports}"
    ...
    def test_scanner_service_limits_configured(self):
        ...
        scanner_services = [
            'ec2', 'rds', 'iam', 's3', 'elbv2', 'autoscaling',
            'elasticache', 'sqs', 'sns', 'cloudwatch', 'logs'
        ]
        ...
        assert len(missing_limits) == 0, f"Services missing rate limits: {missing_limits}"
...
class TestRateLimitingCoverage:
    ...
    def test_sync_scanner_coverage(self):
        ...
        print(f"Scanners with rate limiting: {len(scanners_with_rate_limiting)}/{len(sync_scanners)}")
