...
resource "aws_s3_bucket_policy" "elementtime-lambda-artifacts-stage-policy" {
  # WARNING: S3 bucket elementtime-lambda-artifacts-stage not found in graph
  bucket = "elementtime-lambda-artifacts-stage"
...
resource "aws_s3_bucket_policy" "etime-face-auth-stage-face-images-policy" {
  # WARNING: S3 bucket etime-face-auth-stage-face-images not found in graph
  bucket = "etime-face-auth-stage-face-images"
...
resource "aws_s3_bucket_policy" "ac-terraform-stage-current-policy" {
  # WARNING: S3 bucket ac-terraform-stage-current not found in graph
  bucket = "ac-terraform-stage-current"
...
resource "aws_s3_bucket_policy" "ac-terraform-stage-policy" {
  # WARNING: S3 bucket ac-terraform-stage not found in graph
  bucket = "ac-terraform-stage"
...
resource "aws_s3_bucket_policy" "ac-platform-secure-stage-current-policy" {
  # WARNING: S3 bucket ac-platform-secure-stage-current not found in graph
  bucket = "ac-platform-secure-stage-current"
...
resource "aws_s3_bucket_policy" "ac-secrets-stage-policy" {
  # WARNING: S3 bucket ac-secrets-stage not found in graph
  bucket = "ac-secrets-stage"
...
resource "aws_s3_bucket_policy" "ac-share-int-stage-policy" {
  # WARNING: S3 bucket ac-share-int-stage not found in graph
  bucket = "ac-share-int-stage"

  policy = jsonencode({"Statement": [{"Action": "s3:*", "Effect": "Allow", "Principal": {"AWS": "arn:aws:iam::${var.aws_account_id}:user/leo"}, "Resource": ["arn:aws:s3:::ac-share-int-prod", "arn:aws:s3:::ac-share-int-prod/*"]}, {"Action": ["s3:Get*", "s3:List*"], "Effect": "Allow", "Principal": {"AWS": ["arn:aws:iam::${var.aws_account_id}:user/david.lu", "arn:aws:iam::${var.aws_account_id}:user/matheus.mei", "arn:aws:iam::${var.aws_account_id}:user/isaac.santos", "arn:aws:iam::${var.aws_account_id}:user/rafael"]}, "Resource": ["arn:aws:s3:::ac-share-int-prod", "arn:aws:s3:::ac-share-int-prod/*"]}, {"Action": "s3:*", "Condition": {"Bool": {"aws:SecureTransport": "false"}}, "Effect": "Deny", "Principal": "*", "Resource": ["arn:aws:s3:::ac-share-int-prod/*", "arn:aws:s3:::ac-share-int-prod"], "Sid": "DenyInsecureConnections"}], "Version": "2012-10-17"})
}

# S3 Bucket Policy: ac-platform-secure-stage
resource "aws_s3_bucket_policy" "ac-platform-secure-stage-policy" {
  # WARNING: S3 bucket ac-platform-secure-stage not found in graph
  bucket = "ac-platform-secure-stage"
...
resource "aws_s3_bucket_policy" "ac-flowlogs-vpc-stage-policy" {
  # WARNING: S3 bucket ac-flowlogs-vpc-stage not found in graph
  bucket = "ac-flowlogs-vpc-stage"
...
resource "aws_s3_bucket_policy" "ac-backup-corner-stage-policy" {
  # WARNING: S3 bucket ac-backup-corner-stage not found in graph
  bucket = "ac-backup-corner-stage"
...
resource "aws_s3_bucket_policy" "ac-elementorg-stage-current-policy" {
  # WARNING: S3 bucket ac-elementorg-stage-current not found in graph
  bucket = "ac-elementorg-stage-current"
...
resource "aws_s3_bucket_policy" "ac-elementtime-stage-current-policy" {
  # WARNING: S3 bucket ac-elementtime-stage-current not found in graph
  bucket = "ac-elementtime-stage-current"
...
resource "aws_s3_bucket_policy" "ac-elementorg-stage-policy" {
  # WARNING: S3 bucket ac-elementorg-stage not found in graph
  bucket = "ac-elementorg-stage"
